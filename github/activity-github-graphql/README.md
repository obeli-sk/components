...
It implements the [`account` WIT interface](wit/obelisk-components_github/github.wit).
...
```sh
obelisk client execution submit -f .../account.account-info -- '"your-github-login"'
```
